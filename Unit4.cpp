...
// завантаження номерів на які потрібно перетягувати картинки
...
CheckBox1->Checked=false;
        ...
        // вибір задачі випадковим чином
        random_shuffle(zadacha,zadacha+5);
        z=zadacha[0];
        if (z==1)
        {
                Label1->Caption="Написати програму для знаходження добутку двох чисел.";
        }
        else
        if (z==2)
        {
                Label1->Caption="Написати програму для визначення парності двох чисел.";
        }
        else
        if (z==3)
        {
                Label1->Caption="Написати програмау для визначення об'єму кулі.";
        }
        else
        if (z==4)
        {
                Label1->Caption="Написати програму для знаходження площі трикутника за формулою Герона.";
        }
        else
        if (z==5)
        {
                Label1->Caption="Написати програму для визначення середнього арифметичного" "\n масиву з 5 елементів.";
        }
...
Form5->Label1->Caption="";
        ...
        // перевірка правильності місця розташування
        // program
        ...
        // перевірка правильності задачі № 1
        if (z==1)
        {
...
{
MessageDlg("Програму розробив Яценко О.С.",mtInformation, TMsgDlgButtons() << mbOK,0);
}
//---------------------------------------------------------------------------
